...
HD_PWD='C:/Users/argo-10/Desktop/i2c_project_updated/i2c_project_updated.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_master_new.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_master_new.tcl
